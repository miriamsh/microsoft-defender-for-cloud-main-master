...
class AlertsTreeDataProvider extends vscode_azext_utils_1.AzExtParentTreeItem {
    ...
    async loadMoreChildrenImpl(clearCache, context) {
        ...
        return (0, FilterCommand_1.alertsFiltering)((0, configOperations_1.getConfigurationSettings)(constants_1.Constants.extensionPrefix, constants_1.Constants.filtering)[this.subscription.subscriptionId], this.children);
    }
    hasMoreChildrenImpl() {
        return false;
    }
