...
class Notification {
    ...
    async setEmailNotificationSettings(context) {
        ...
        await this.securityCenterClient.securityContacts.create("default", contactsDetails).then(async (response) => {
            await (0, configUtils_1.setConfigurationSettings)(constants_1.Constants.extensionPrefix, constants_1.Constants.emailNotificationSettings, this.securityCenterClient.subscriptionId, response, vscode.ConfigurationTarget.Global);
...
//# sourceMappingURL=setNotificationSettingsCommand.js.map