...
async function multiStepInput(context, subscription) {
    const configSettings = (0, configOperations_1.getConfigurationSettings)(constants_1.Constants.extensionPrefix, constants_1.Constants.emailNotificationSettings)[subscription.subscriptionId];
    const settings = {
    ...
    async function collectInputs() {
        const state = {};
        await multiStepInput_1.MultiStepInput.run(input => inputAdditionalEmails(input));
        return state;
    }
